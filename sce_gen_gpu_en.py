...
def parse_args():
    parser = argparse.ArgumentParser(description="GPU version of the RL scenario-generation training script")
    parser.add_argument('--gpu', type=int, default=0, help='which GPU to use (each GPU runs independently for multi-GPU)')
    parser.add_argument('--timesteps', type=int, default=200000, help='total training timesteps')
    parser.add_argument('--seed', type=int, default=0, help='random seed (each GPU uses a different seed for multi-GPU)')
